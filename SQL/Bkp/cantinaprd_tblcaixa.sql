...
CREATE TABLE `tblcaixa` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_TBLCAIXA_TBLFUNCIONARIO1_idx` (`TBLFUNCIONARIO_id`),
  CONSTRAINT `fk_TBLCAIXA_TBLFUNCIONARIO1` FOREIGN KEY (`TBLFUNCIONARIO_id`) REFERENCES `tblfuncionario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
